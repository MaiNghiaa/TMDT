...
//  lấy thông tin vè sinh viên có id là...
$edit_sql = "SELECT * FROM san_pham WHERE id_product = $getid";
    ...
    if (isset($_POST['product_type'])) {
        ...
        if ($_FILES["image"]["error"] === 4) {
            ...
            if (!in_array($imageExtention, $validImageExtention)) {
                ...
                $query = "UPDATE `san_pham` SET `Product` = '$Product', `description` = '$Description', `price` = '$Price', `Image` = '$newImageName', `id_product_type` = '$product_type' WHERE `san_pham`.`id_product` = $getid;";
            ...
            <div class="page-content">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="Product" class="form-control" id="Product" placeholder="Nhập sản phẩm" value="<?php echo $row['Product']?>">
                    </div>
                    <div class="form-group">
                        <label for="description">Mô tả</label>
                        <input type="text" name="description" class="form-control" id="description" rows="3" value="<?php echo $row['description']?>"></input>
                    </div>
                    <div class="form-group">
                        <label for="price">Price</label>
                        <input type="number" name="price" class="form-control" id="price" placeholder="Giá" value="<?php echo $row['price']?>">
                    </div>
                    <div class="form-group">
                        <label for="photo">Images</label>
                        <input type="file" name="image" class="form-control-file" id="image" accept=".jpg, .jpeg, .png" value="<?php echo $row['Image']?>">
                    </div>
