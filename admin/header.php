								...
								<a class="dropdown-item" href="javascript:;">
									<div class="d-flex align-items-center">
										<div class="user-online">
											<img src="assets/images/avatars/ducngu.jpg" class="msg-avatar" alt="user avatar">
										</div>
										<div class="flex-grow-1">
											<h6 class="msg-name">Anh đức <span class="msg-time float-end">14
													sec ago</span></h6>
											<p class="msg-info">Chơi liên minh thôi </p>
										</div>
									</div>
								</a>
							</div>
