...
require 'connect.php';
$rows = mysqli_query($conn, "SELECT * FROM san_pham ORDER BY id_product DESC LIMIT $begin,5");
					...
					<div class="card-body">
						<div class="d-lg-flex align-items-center mb-4 gap-3">
							<div class="position-relative">
								...
								<input type="text" name="tukhoa" class="form-control ps-5 radius-30" placeholder="Search">
								<span class="position-absolute top-50 product-show translate-middle-y"><input type="submit" name="timkiem" value="">
								<i class="bx bx-search"></i>
								</span>
							</form>
							</div>
							<div class="ms-auto"><a href="them_product.php" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add New Product</a></div>
						</div>
